...
class HTML4RendererTestCase(TestCase):
    ...
    def get_html(self, element, full_page = False):
        ...
        from magicbullet.html.renderers import HTML4Renderer
    ...
    def test_content(self):
        from magicbullet.html.element import Content     
    ...
    def test_single_elements_with_children(self):
        ...
        from magicbullet.html.element import Element
        from magicbullet.html.renderers import HTML4Renderer, RenderingError
...
class XHTMLRendererTestCase(TestCase):
    ...
    def get_html(self, element):
        from magicbullet.html.renderers import XHTMLRenderer
