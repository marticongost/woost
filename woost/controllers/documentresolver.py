...
class DocumentResolver(object):
    ...
    Document resolvers are used by the L{CMS<woost.controllers.application.CMS>}
    ...
    def get_document(self,
        ...
        @return: The matching document, or None if there's no document matching
            the indicated path.
        @rtype: L{Document<woost.models.document.Document>}
        """
    ...
    def get_path(self, document):
        ...
        @type document: L{Document<woost.models.document.Document>}
...
class HierarchicalPathResolver(DocumentResolver):
    ...
    L{path<woost.models.Document.path>},
    L{full_path<woost.models.Document.full_path>} and
    L{parent<woost.models.Document.parent>} members of the
    L{Document<woost.models.Document>} class."""
