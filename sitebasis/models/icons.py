...
class IconResolver(object):
    ...
    @type file_resolvers: (L{Item<sitebasis.models.Item>} class, callable)
    ...
    def __init__(self):
        self.icon_repositories = [
            resource_filename("sitebasis.views", "resources/images/icons")
        ]
    ...
    def find_icon(self, item, size):
        ...
        @type item: L{Item<sitebasis.models.Item>} instance or class
