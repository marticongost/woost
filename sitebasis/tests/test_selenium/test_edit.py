...
from sitebasis.models import Item, Document, Template
...
class ItemSelectorTestCase(object):
    ...
    def test_select(self):
        ...
        browser.open("/en/cms/content/new/?item_type=sitebasis.models.document.Document")
        admin_login()
...
class IntegralSelectorTestCase(object):
    ...
    def test_new(self):
        ...
        browser.open(
            "/en/cms/content/new/"
            "?item_type=sitebasis.tests.test_selenium.test_edit.EditTestModel"
        )
        admin_login()
